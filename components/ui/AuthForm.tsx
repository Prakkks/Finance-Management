...
import { getLoggedInUser, signIns, signUps } from '@/lib/actions/user.actions';
              ...
              {type === 'sign-up' && (
                <>
                  <div className="flex gap-4">
                    ...
                    <CustomInput control={form.control} name='lastname' label="Last Name" placeholder='Enter your lastname' />
                  </div>
